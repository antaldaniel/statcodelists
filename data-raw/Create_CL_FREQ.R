...
temp_excel_file <- file.path(tempdir(), "CL_FREQ.xlsx")

download.file(url = 'https://registry.sdmx.org/ws/public/sdmxapi/rest/codelist/SDMX/CL_FREQ/2.1?format=xlsx&detail=full&references=none&saveAS=CL_FREQ.xlsx',
